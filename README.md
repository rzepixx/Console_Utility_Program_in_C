...
- Mathematical calculations (geometry, fines, multiplication tables)
- Display of patterns (e.g., stars)
- Array operations (random numbers, min/max, sorting, averages)
